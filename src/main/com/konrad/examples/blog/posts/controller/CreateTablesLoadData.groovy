...
import com.konrad.examples.blog.posts.domain.CatalogItem
import com.konrad.examples.blog.posts.domain.Posts
...
public class CreateTablesLoadData {
    ...
    static AWSCredentialsProvider was = new AWSCredentialsProvider() {
        @Override
    ...
    static AmazonDynamoDB cl = AmazonDynamoDBClientBuilder.standard().withCredentials(was).withEndpointConfiguration(new AwsClientBuilder.EndpointConfiguration("http://localhost:8000", "us-east-1")).build()

    static DynamoDB dynamoDB = new DynamoDB(cl);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            DynamoDBMapper mapper = new DynamoDBMapper(cl)
            //createTable("Posts3", 1L, 1L, "Id", "S");
            //deleteTable(productCatalogTableName);
            createTable("Posts2", 10L, 5L, "Id", "S");
            ...
            //System.out.println(dynamoDB.getTable("ProductCatalog").getItem("Id", 101))
