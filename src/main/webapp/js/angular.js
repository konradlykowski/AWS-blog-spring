...
app.controller('ModalInstanceCtrl', function($scope, $uibModalInstance, postId) {
  ...
  $scope.content = "Japonia to niezwykły kraj z bogatym dobytkiem kulturowym. Wszystko tam było dla mnie niezwykle: ludzie, obyczaje, stroje, język oraz jedzenie. Pomimo względnego tłoku na ulicach, dworcach oraz metrze, ludzie są “dziwnie” spokojni. Nigdy dotychczas się z czymś takim nie spotkałam.<p/>"+
                    ...
                    "Słyszałam kiedyś takie japońskie przysłowie: “jeśli gwóźdź wystaje, trzeba go natychmiast wbić na miejsce”. Dokładnie tak samo jest w kwestii stroju, każdy jest taki sam i nikt nie “wystaje” jak owy gwóźdź. <br/>"+
                    "<br/><span class=\"modal-title\">KIMONO</span><br/>"+
                    ...
                    "W Japonii kimona noszą też mężczyźni. Mają one stały kształt i wykonane są z tkanin o stonowanych barwach. Odmiennie niż w przypadku kimon damskich rodzaj i rangę uroczystości rozróżnia się poprzez dobór odpowiednich dodatków. <br/>"+
